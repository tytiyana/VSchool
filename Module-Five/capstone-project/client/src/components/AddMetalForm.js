...
function AddMetalForm(props){
    const initInputs = {name: props.name || "", rarity: props.rarity || "", yearDiscovered: props.yearDiscovered || "", meltingPoint: props.meltingPoint || "", description: props.description || ""}
