...
class App extends React.Component {
    ...
    render() {
        const topTextcolor = {
            color: this.state.meme.topColor
        }
        const bottomTextColor = {
            color: this.state.meme.bottomColor
        }
        const memeComponents = this.state.memeList.map(memeObject => <SavedMeme key={
                memeObject.id
            }
            meme={memeObject}
            delete={
                ...
                <div>
                    ...
                    <div id='creationContainer'>
                        ...
                        <form id='memeForm'>
                            <div>
                                <label>
                                    <input type='text' name='topText' className='inputBox'
                                        value={
                                            this.state.meme.topText
                                        }
                                        maxLength='32'
                            ...
                            <div>
                                <label>
                                    <input type='text' name='bottomText' className='inputBox'
                                        value={
                                            this.state.meme.bottomText
                                        }
                                        maxLength='32'
                                ...
                                <label className='colorInput'>Bottom Color {' '}
                                    <input type='color' name='bottomColor'
                                        value={
                                            this.state.meme.bottomColor
                                        }
                                        onChange={
                                            this.handleChange
                                        }/>
